...
namespace qon.Variables.Domains
{
    ...
    public class NumericalDomain<TQ> : IDomain<TQ> where TQ : notnull //TODO: Future: Refactor this shit with INumber<TQ> as soon as available in Unity3D
    {
        ...
        //TODO: Future: C# 10 supports random long
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        public Optional<TQ> SingleOrEmptyValue()
        {
            if (Size() == 1)
            {
                return Optional<TQ>.Of(Domain[0].Start);
            }
        ...
        //TODO: Future: Holy fuck, redo this shit, when will be able to work with generic math via INumber<T>
